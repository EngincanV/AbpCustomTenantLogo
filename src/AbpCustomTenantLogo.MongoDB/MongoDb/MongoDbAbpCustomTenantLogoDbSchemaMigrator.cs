...
using AbpCustomTenantLogo.Data;
using Volo.Abp.Data;
...
public class MongoDbAbpCustomTenantLogoDbSchemaMigrator : IAbpCustomTenantLogoDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbAbpCustomTenantLogoDbSchemaMigrator(IServiceProvider serviceProvider)
    {
